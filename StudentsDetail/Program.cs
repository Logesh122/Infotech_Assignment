...
builder.Services.AddDbContext<StudentDetailsDbContext>
    (options => options.UseSqlServer(builder.Configuration.GetConnectionString("StudentDetailsConnectionString")));
